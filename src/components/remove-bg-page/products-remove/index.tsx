...
function ProductsRemove() {
  return (
    <section>
      <Container className='mt-20 grid place-items-center'>
        ...
        <p className='mx-auto mt-5 text-center text-base text-gray-500 lg:max-w-2xl'>
          Instantly obtain transparent backgrounds to instantly remove
          backgrounds from any images. Permit you to change the backdrop and
          adjust the spectacular banners, product images, and profile to your
          own specifications.
        </p>
